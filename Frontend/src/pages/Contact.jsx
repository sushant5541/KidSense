          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="animate-on-scroll slide-left">
              ...
              <div className="flex flex-col sm:flex-row gap-6">
                <a href="tel:+918041234567" className="btn-gold flex items-center justify-center gap-2">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  +91 80 4123 4567
                </a>
                <a href="mailto:contact@kidsense.in" className="btn-outline-gold flex items-center justify-center gap-2 border-white/20 text-white hover:border-ks-gold hover:text-ks-gold">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <form className="space-y-6">
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">Phone Number</label>
                    <input type="tel" className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-ks-gold focus:border-ks-gold outline-none transition-all" placeholder="+91 90000 00000" />
                </div>
                <div>
            ...
            <div className="animate-on-scroll slide-right space-y-12">
                ...
                <div className="grid grid-cols-1 gap-6">
                  ...
                  <div className="flex items-start gap-4 p-6 bg-white border border-gray-100 rounded-3xl shadow-lg shadow-gray-100 hover:shadow-xl transition-shadow">
                    ...
                    <div>
                      ...
                      <p className="text-gray-500">123, 100 Feet Rd, Indiranagar, Bengaluru KA 560038</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  {['Indiranagar', 'Koramangala', 'Jayanagar', 'HSR Layout', 'Whitefield', 'Malleshwaram'].map(loc => (
